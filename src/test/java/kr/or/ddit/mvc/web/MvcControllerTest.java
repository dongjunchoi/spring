...
public class MvcControllerTest extends WebTestConfig{
	...
	@Test
	public void filuploadTest() throws Exception {
		
		//String name, String originalFilename, String contentType, InputStream inputStream 
		ClassPathResource resoure = new ClassPathResource("kr/or/ddit/upload/sally.png");
		
		MockMultipartFile file = 
					new MockMultipartFile("picture", "sally.png", "image/png", resoure.getInputStream());
